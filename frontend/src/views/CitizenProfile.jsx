      ...
      <header className="bg-white border-b sticky top-0 z-50 shadow-sm">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link to="/report" className="text-gray-700 hover:text-green-600 transition">Citizen Portal</Link>
            <Link to="/leaderboard" className="text-gray-700 hover:text-green-600 transition">Leaderboard</Link>
            <Link to="/citizen/profile" className="text-green-600 font-semibold">Profile</Link>
          </div>
        </nav>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">{profile?.name || 'User'}</h1>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-green-50 rounded-lg p-6">
              ...
              <div className="text-4xl font-bold text-green-600">{profile?.ecoPoints || 0}</div>
              <div className="text-sm text-gray-500 mt-2">Keep reporting to earn more!</div>
            </div>
            <div className="bg-blue-50 rounded-lg p-6">
              <div className="text-sm text-gray-600 mb-2">Complaints Raised</div>
              <div className="text-4xl font-bold text-blue-600">{profile?.complaintsCount || 0}</div>
              <div className="text-sm text-gray-500 mt-2">Total issues reported</div>
            </div>
          </div>
